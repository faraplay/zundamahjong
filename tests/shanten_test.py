    ...
    def test_shanten_1(self):
        ...
        self.assertEqual(
            data,
            {
                ...
                1 * 2 + 1: [1, 0b111_111_111],
                2 * 2 + 0: [1, 0b111_111_111],
                2 * 2 + 1: [1, 0b111_111_111],
                3 * 2 + 0: [1, 0b111_111_111],
                3 * 2 + 1: [1, 0b111_111_111],
                4 * 2 + 0: [1, 0b111_111_111],
                4 * 2 + 1: [1, 0b111_111_111],
            },
        )
    ...
    def test_shanten_34(self):
        ...
        self.assertEqual(
            data,
            {
                ...
                1 * 2 + 1: [2, 0b111_111_111],
                2 * 2 + 0: [2, 0b111_111_111],
                2 * 2 + 1: [2, 0b111_111_111],
                3 * 2 + 0: [2, 0b111_111_111],
                3 * 2 + 1: [2, 0b111_111_111],
                4 * 2 + 0: [2, 0b111_111_111],
                4 * 2 + 1: [2, 0b111_111_111],
            },
        )
    ...
    def test_shanten_2344(self):
        ...
        self.assertEqual(
            data,
            {
                ...
                2 * 2 + 1: [4, 0b111_111_111],
                3 * 2 + 0: [4, 0b111_111_111],
                3 * 2 + 1: [4, 0b111_111_111],
                4 * 2 + 0: [4, 0b111_111_111],
                4 * 2 + 1: [4, 0b111_111_111],
            },
        )
    ...
    def test_shanten_233444556(self):
        ...
        self.assertEqual(
            data,
            {
                ...
                3 * 2 + 1: [9, 0b111_111_111],
                4 * 2 + 0: [9, 0b111_111_111],
                4 * 2 + 1: [9, 0b111_111_111],
            },
        )
